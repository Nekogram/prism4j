...
public class TestHaxe {

    private final String file;
    private Prism4j prism4j;

    public TestHaxe(@NotNull String file) {
        this.file = file;
    }
    ...
    public static Collection<Object> parameters() {
        return TestUtils.testFiles("haxe");
    }
    ...
    public void test() {
        ...
        TestUtils.assertCase(c, prism4j.tokenize(c.input, Objects.requireNonNull(prism4j.grammar("haxe"))));
    }

    @Test
    public void testClone() {
        final TestUtils.Case c = TestUtils.readCase(file);
        final Grammar grammar = GrammarUtils.clone(Objects.requireNonNull(prism4j.grammar("haxe")));
