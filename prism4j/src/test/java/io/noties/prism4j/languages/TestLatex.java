...
public class TestLatex {
    ...
    public TestLatex(@NotNull String file) {
        this.file = file;
    }
    ...
    public static Collection<Object> parameters() {
        return TestUtils.testFiles("latex");
    }
    ...
    public void testClone() {
        final TestUtils.Case c = TestUtils.readCase(file);
        final Grammar grammar = GrammarUtils.clone(Objects.requireNonNull(prism4j.grammar("latex")));
