...
public class TestBrainfuck {
    ...
    public TestBrainfuck(@NotNull String file) {
        this.file = file;
    }
    ...
    public static List<String> parameters() {
        return TestUtils.testFiles("brainfuck");
    }
    ...
    public void testClone() {
        final TestUtils.Case c = TestUtils.readCase(file);
        final Grammar grammar = GrammarUtils.clone(Objects.requireNonNull(prism4j.grammar("brainfuck")));
